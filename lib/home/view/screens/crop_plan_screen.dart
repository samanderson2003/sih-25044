...
class _CropPlanScreenState extends State<CropPlanScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final DateTime plantingDate = DateTime(currentYear, widget.startMonth, 1);
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    ' ${DateFormat('MMMM d').format(plantingDate)}',
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: widget.crop.lifecycleStages.isEmpty
            ? Center(
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        const TranslatedText(
                          "No detailed schedule available for",
            ...
            : Timeline.tileBuilder(
                ...
                builder: TimelineTileBuilder.connected(
                  ...
                  itemCount: widget.crop.lifecycleStages.length,
                  ...
                  indicatorBuilder: (_, index) {
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        color: widget.crop.themeColor.withOpacity(0.1),
                      ...
                      child: Icon(
                        widget.crop.lifecycleStages[index].iconData,
                        color: widget.crop.themeColor,
                        size: 20,
                      ),
                    );
                  ...
                  connectorBuilder: (_, index, __) => SolidLineConnector(
                    color: widget.crop.themeColor.withOpacity(0.5),
                  ),

                  // The Content (Day 5, Actions, etc)
                  contentsBuilder: (context, index) {
                    final stage = widget.crop.lifecycleStages[index];
                    // Calculate the actual calendar date for this stage
                    final stageDate = plantingDate.add(
                      Duration(days: stage.daysAfterPlanting - 1),
                    );
